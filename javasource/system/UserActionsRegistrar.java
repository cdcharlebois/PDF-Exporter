...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(pdf_exporter.actions.BuildPDF.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.GetFieldsFromPDF.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.GetPDFField_viaMxXpath.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.InjectFieldNamesIntoPDF.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.RetrieveAttributeValueByPath.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.RetrieveDateValueByAttribute.class);
			component.actionRegistry().registerUserAction(pdf_exporter.actions.RetrieveStringValueByAttribute.class);
